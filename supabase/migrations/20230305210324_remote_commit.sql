...
ALTER TABLE "public"."room_events" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: rooms rooms_game_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: clues Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for all users" ON "public"."clues" FOR INSERT WITH CHECK (true);
...
--
-- Name: room_events Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for all users" ON "public"."room_events" FOR INSERT WITH CHECK (true);


--
-- Name: rooms Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for all users" ON "public"."rooms" FOR INSERT WITH CHECK (true);


--
-- Name: clues Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON "public"."clues" FOR SELECT USING (true);
...
--
-- Name: room_events Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable read access for all users" ON "public"."room_events" FOR SELECT USING (true);
...
--
-- Name: clues; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: room_events; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "clues"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "clues_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON SEQUENCE "public"."room_events_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."room_events_id_seq" TO "authenticated";
