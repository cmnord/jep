/** Heroicon name: outline/user-minus */
export function UserMinus({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
      role="img"
      aria-labelledby="user-minus-title"
    >
      <title id="user-minus-title">Remove player</title>
      <path
        strokeLinecap="round"
